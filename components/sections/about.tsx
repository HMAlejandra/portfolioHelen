          ...
          <div className="lg:col-span-5 relative">
            ...
            <div className="mt-8 space-y-2">
              <div className="flex items-center gap-2">
                ...
                <p className="text-[10px] tracking-[0.2em] uppercase font-bold text-black/60 dark:text-white/60">
                  {t("about.location")}
                </p>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="lg:col-span-7">
            <FadeIn delay={0.3}>
              <h2 className="text-5xl md:text-7xl font-serif font-normal leading-[0.9] mb-12 text-[#111111] dark:text-white">
                {t("about.hello")} <br />
                <span className="text-[#ff4d00]">{t("about.name")}</span>
              </h2>
            </FadeIn>
            ...
            <div className="space-y-10">
              ...
              <div className="pt-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <p className="text-[10px] font-black tracking-[0.3em] uppercase text-[#ff4d00]">
                    {t("about.stack")}
                  </p>
                </div>
                <div className="flex flex-wrap gap-2">
                  {["Next.js", "React", "TypeScript", "TailwindCSS", "Framer Motion"].map((keyword, i) => (
                    <span
                      key={i}
                      className="px-4 py-2 bg-[#111111] dark:bg-white/10 text-white text-[10px] font-mono tracking-tighter rounded-sm hover:bg-[#ff4d00] transition-colors cursor-default"
                    >
              ...
              <FadeIn delay={1.2} className="pt-10">
                ...
                >
                  ...
                  <div className="flex flex-col">
                    <span className="text-[10px] font-mono text-[#ff4d00] mb-1">
                      {t("about.cv.cmd")}
                    </span>
